...
export default function PublicInnovatorProfile() {
  ...
  return (
    <div className="min-h-screen bg-[#050A16] pt-12 pb-24 relative selection:bg-[#FF6B6B] selection:text-black font-['Poppins',sans-serif]">
        ...
        <div className="min-h-[400px]">
          ...
          {activeTab === "academic" && (
            <div className="space-y-0 divide-y divide-white/5 animate-in fade-in duration-500">
              ...
              <InfoRow icon={Globe} label="Year / Semester" value={`${profile.year} Year, Sem ${profile.sem}`} />
